...
![Zcash (ZEC) Logosu](https://farukguler.com/assets/post_images/z-cash.PNG) Zcash (ZEC), 2016 yılında Bitcoin kod tabanından (fork) türetilmiş, merkeziyetsiz ve açık kaynaklı bir **gizlilik odaklı** kripto para birimidir. Projenin temel misyonu, Bitcoin'in (ve diğer tüm halka açık blockchain'lerin) doğasında bulunan **şeffaflık sorununu** çözmektir.
